...
const BackDrop = styled(motion.div)`
  ...
  background: linear-gradient(58deg, rgba(10,109,182,1) 24%, rgba(13,170,165,1) 95%);
`;
  ...
  return (
    <AccountContext.Provider value={contextValue}>
      <BoxContainer>
        ...
        <InnerContainer>
          {active === "iniciar_sesion" && <LoginForm switchToSignup={switchToSignup} />}
          {active === "registrarse" && <SignupForm switchToSignin={switchToSignin}/>}
